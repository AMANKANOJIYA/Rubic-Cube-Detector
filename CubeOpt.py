...
class CubeOpt:
    ...
    def ColorDetection(self, color, hsv):
        ...
        '''
        colordict={"Red":[[0, 50, 70],[9, 255, 255],[159, 50, 70],[180, 255, 255],"R"],"Blue":[[90, 50, 70],[128, 255, 255],"B"],"Green":[[36, 50, 70],[89, 255, 255],"G"],"White":[[0, 0, 231],[180, 18, 255],"W"],"Orange":[[18, 40, 90],[27,255,255],"O"],"Yellow":[[ 25, 70, 120],[35,255,255],"Y"]}
